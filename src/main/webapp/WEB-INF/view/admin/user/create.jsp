            ...
            <form:form action="/admin/user/create" method="POST" modelAttribute="newUser" class="row"
              ...
              <div class="mb-3 col-12 col-md-6">
                ...
                <spring:bind path="newUser.fullName">
                  <form:input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" path="fullName" />
                </spring:bind>
              ...
              <div class="mb-3 col-12 col-md-6">
                ...
                <input name="avatarFile" type="file" class="form-control" id="uploadFile" accept=".png, .jpg, .jpeg">
              </div>
